...
namespace LINA
{
  ...
  public:
    ...
    struct SortStart : public std::less<TimePeriod>
    {
      bool operator()(const TimePeriod& left, const TimePeriod& right) const
      {
        left.start < right.start;
      }
    };

    struct SortEnd : public std::less<TimePeriod>
    {
      bool operator()(const TimePeriod& left, const TimePeriod& right) const
      {
        left.end < right.end;
  ...
  typedef std::set<Event,TimePeriod::SortEnd> EventSetSE;
  typedef std::set<Event,TimePeriod::SortStart> EventSetSS;
  ...
  enum EventStatusEnum { EventNotStarted, EventOngoing, EventFinished};
  ...
  public:
    ...
    /// Return vector of ongoing events
    const EventSetSE* PollEvents();
  ...
  private:
    ...
    EventSetSS events_notstarted;
    EventSetSE events_ongoing;
    EventSetSE events_finished;
    Time current_time;
  };
